/*
  ...
  - You are about to drop the column `status_sent` on the `monitors` table. All the data in the column will be lost.
...
INSERT INTO "new_monitors" ("current_status", "host", "id", "interval", "last_attempt", "last_response", "last_response_time", "next_retry", "notification_sent", "notified_at", "port", "reference", "retries", "retry_count", "source", "synced_at", "type") SELECT "current_status", "host", "id", "interval", "last_attempt", "last_response", "last_response_time", "next_retry", "notification_sent", "notified_at", "port", "reference", "retries", "retry_count", "source", "synced_at", "type" FROM "monitors";
DROP TABLE "monitors";
